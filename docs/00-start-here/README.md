...
Nothing here assumes prior knowledge of Python, Git, terminals, virtual
environments, or astronomy.

## The lessons

| # | Lesson | What you get |
|---|---|---|
| 1 | [What is this?](what-is-this.md) | Why Moonfield exists and how to use it |
| 2 | [Setup](setup.md) | Working install on Windows, macOS or Linux |
| 3 | [Your first command](first-command.md) | Run something and understand the output |
| 4 | [Pre-flight check](pre-flight.md) | Confirm your environment is trustworthy |
| 5 | [Editors and IDEs](editors.md) | Optional. What they are, whether you need one |
...
That is expected, and it is not a sign you are bad at this. Go to
