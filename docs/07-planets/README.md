...
Where the planets are, why they sometimes appear to move backwards, and how
...
- Module 02 (synodic periods)
- Module 05 (local sky)

## Intended approach

`src/moonfield/planets.py`, using VSOP87 truncated series in the same style as `moon.py`.
